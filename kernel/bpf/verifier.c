...
pblk_func_proto(enum bpf_func_id func_id, const struct bpf_prog *prog)
{
        //fill here to add helper fucntions
        return NULL;
}

static bool pblk_is_valid_access(int off, int size,
...
const struct bpf_verifier_ops pblk_verifier_ops = {
        .get_func_proto  = pblk_func_proto,
        .is_valid_access = pblk_is_valid_access,
};
